...
import 'package:chatapp/Screens/Broadcast/BroadcastDetails.dart';
...
import 'package:chatapp/Services/Providers/BroadcastProvider.dart';
...
import 'package:chatapp/widgets/DocumentPicker/documentPicker.dart';
...
class _BroadcastChatPageState extends State<BroadcastChatPage>
          ...
          builder: (BuildContext popable) => ListTile(
              ...
              onTap: () async {
                ...
                await FirebaseFirestore.instance
                    ...
                    .delete();
                chatapp.toast(getTranslated(this.context, 'deleted'));
              })));
    }
  ...
  Widget build(BuildContext context) {
    ...
    return PickupLayout(
        prefs: widget.prefs,
        scaffold: chatapp.getNTPWrappedWidget(Consumer<List<BroadcastModel>>(
