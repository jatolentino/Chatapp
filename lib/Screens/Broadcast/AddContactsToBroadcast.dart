                                                                          ...
                                                                          child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                                                                            ...
                                                                            Padding(
                                                                              ...
                                                                              child: Text(
                                                                                ...
                                                                                textAlign: TextAlign.left,
                                                                                style: TextStyle(color: pickTextColorBasedOnBgColorAdvanced(Thm.isDarktheme(widget.prefs) ? chatappDIALOGColorDarkMode : chatappDIALOGColorLightMode), fontWeight: FontWeight.bold, fontSize: 16.5),
                                                                              ),
                                                                            ),
                                                                            SizedBox(
                                                                              height: 10,
                                                                                ...
                                                                                onPressed: () async {
                                                                                  ...
                                                                                  await FirebaseFirestore.instance.collection(DbPaths.collectionbroadcasts).doc(widget.currentUserNo!.toString() + '--' + time.millisecondsSinceEpoch.toString()).set(broadcastdata).then((value) async {
                                                                                    await FirebaseFirestore.instance.collection(DbPaths.collectionbroadcasts).doc(widget.currentUserNo!.toString() + '--' + time.millisecondsSinceEpoch.toString()).collection(DbPaths.collectionbroadcastsChats).doc(time2.millisecondsSinceEpoch.toString() + '--' + widget.currentUserNo!.toString()).set({
                                                                                      ...
                                                                                      chatapp.toast('Error Creating Broadcast. $err');
                                                                                  ...
                                                                                  children: [
                                                                                    WidgetSpan(
                                                                                      child: Padding(
                                                                                        ...
                                                                                        child: Icon(
                                                                                          Icons.contact_page,
                                                                                          color: chatappPRIMARYcolor.withOpacity(0.7),
                                                                                          size: 14,
                                                                                        ),
                                                                                      ),
                                                                                    ),
                                                                                    TextSpan(
                                                                                        ...
                                                                                        style: TextStyle(color: chatappSECONDARYolor.withOpacity(0.7), height: 1.3, fontSize: 13, fontWeight: FontWeight.w400)),
                                                                                  ],
                                                                                ),
                                                                              )),
                                                                        ),
                                                                        ...
                                                                        builder: (BuildContext
                                                                          ...
                                                                          if (snapshot
                                                                            ...
                                                                            LocalUserData
                                                                                ...
                                                                                snapshot.data!;
                                                                            return Container(
                                                                              color: Thm.isDarktheme(widget.prefs) ? chatappCONTAINERboxColorDarkMode : chatappCONTAINERboxColorLightMode,
                                                                              child: Column(
                                                                                children: [
                                                                                  ListTile(
                                                                                    ...
                                                                                    trailing: Container(
                                                                                      decoration: BoxDecoration(
                                                                                        border: Border.all(color: chatappGrey, width: 1),
                                                                                    ...
                                                                                    title: Text(user.name,
                                                                                        style: TextStyle(
                                                                                          color: pickTextColorBasedOnBgColorAdvanced(Thm.isDarktheme(widget.prefs) ? chatappCONTAINERboxColorDarkMode : chatappCONTAINERboxColorLightMode),
                                                                                        )),
                                                                                    subtitle: Text(phone, style: TextStyle(color: chatappGrey)),
