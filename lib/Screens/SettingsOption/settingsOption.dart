            ...
            children: [
                            ...
                            ListTile(
                              trailing: SizedBox(
                                ...
                                child: isLoading == true
                                    ...
                                    : Switch(
                                        activeColor: chatappPRIMARYcolor,
                              ...
                              leading: Padding(
                                ...
                                child: Icon(
                                  ...
                                  color:
                                      chatappPRIMARYcolor.withOpacity(0.85),
                                  size: 26,
                                ),
                              ),
                              title: Text(
                          ...
                          ListTile(
                            trailing: SizedBox(
                                ...
                                child: Align(
                                  ...
                                  child: LinearProgressIndicator(
                                    backgroundColor:
                                        chatappPRIMARYcolor.withOpacity(0.4),
                            ...
                            leading: Padding(
                              ...
                              child: Icon(
                                Icons.notifications_on,
                                color: chatappPRIMARYcolor.withOpacity(0.85),
                                size: 26,
                              ),
                            ),
                            title: Text(
              ...
              ListTile(
                ...
                subtitle: Padding(
                  ...
                  child: Text(
                    ...
                    maxLines: 1,
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(fontSize: 14, color: chatappGrey),
                  ),
                ),
              ),
              ListTile(
                            ...
                            child: Column(
                              ...
                              children: [
                                Icon(Icons.check_circle_outline_rounded,
                                    color: chatappGreenColor400, size: 45),
                                SizedBox(
                                  height: 20,
                                ),
                                Text(
              ...
              Padding(
                ...
                child: Text(
                  ...
                  textAlign: TextAlign.center,
                  style: TextStyle(color: chatappGrey, fontSize: 12),
                ),
              ),
              SizedBox(
                height: 17,
