...
import 'package:chatapp/Screens/homepage/homepage.dart';
...
import 'package:chatapp/Services/Providers/TimerProvider.dart';
...
import 'package:chatapp/widgets/PhoneField/countries.dart';
import 'package:chatapp/widgets/PhoneField/intl_phone_field.dart';
import 'package:chatapp/widgets/PhoneField/phone_number.dart';
...
class LoginScreenState extends State<LoginScreen>
  ...
  detectLocale() async {
    await Devicelocale.currentLocale.then((locale) async {
      // chatapp.toast("ssdd${locale.toString()}");
      if (locale != null) {
  ...
  Future<void> verifyPhoneNumber() async {
    ...
    final PhoneVerificationFailed verificationFailed =
      ...
      chatapp.toast('Authentication failed - ${authException.message}');
    };
    ...
    final PhoneCodeAutoRetrievalTimeout codeAutoRetrievalTimeout =
      ...
      if (mounted) {
        ...
        chatapp.toast('Authentication failed Timeout. please try again.');
      }
    };
    ...
    // } catch (e) {
    //   chatapp.toast('NEW CATCH' + e.toString());
    // }
  }
  ...
  Future<Null> handleSignIn({AuthCredential? authCredential}) async {
    ...
    try {
        ...
        if (documents.length == 0) {
          ...
          if (fcmTokenn != null) {
            ...
            unawaited(Navigator.pushReplacement(
                ...
                new MaterialPageRoute(
                    builder: (context) => chatappWrapper())));
            chatapp.toast(getTranslated(this.context, 'failedtologin'));
          }
        } else {
          ...
          if (fcmToken != null) {
            ...
            unawaited(Navigator.pushReplacement(
                ...
                new MaterialPageRoute(
                    builder: (context) => chatappWrapper())));
            chatapp.toast(getTranslated(this.context, 'welcomeback'));
          } else {
            unawaited(Navigator.pushReplacement(
                this.context,
                new MaterialPageRoute(
                    builder: (context) => chatappWrapper())));
            chatapp.toast(getTranslated(this.context, 'failedlogin'));
          }
        }
      } else {
        chatapp.toast(getTranslated(this.context, 'failedlogin'));
      ...
      if (e.toString().contains('invalid') ||
        ...
        chatapp.toast(getTranslated(this.context, 'makesureotp'));
      }
    }
  }
        ...
        child: Column(
          children: <Widget>[
            ...
            w < h
                ? Image.asset(
                    !Thm.isDarktheme(widget.prefs)
                        ? isDarkColor(chatappAPPBARcolorLightMode)
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            ...
                            child: MySimpleButton(
                              ...
                              spacing: 0.3,
                              height: 57,
                              buttoncolor: chatappSECONDARYolor,
                              buttontext:
            ...
            child: Padding(
              ...
              child: PinFieldAutoFill(
                ...
                decoration: UnderlineDecoration(
                  bgColorBuilder:
                      FixedColorBuilder(chatappGrey.withOpacity(0.1)),
                  textStyle: TextStyle(
                      fontSize: 22,
                      color: chatappBlack,
                ...
                onCodeSubmitted: (code) {
                  ...
                  if (code.length == 6) {
                    ...
                    chatapp.toast(getTranslated(this.context, 'correctotp'));
                  }
                },
                onCodeChanged: (code) {
                  if (code!.length == 6) {
          ...
          Padding(
            ...
            child: Text(
              getTranslated(this.context, 'enter_verfcode') +
                  ' $phoneCode-${_phoneNo.text}',
              textAlign: TextAlign.center,
              style: TextStyle(height: 1.5, color: chatappBlack),
  ...
  Widget build(BuildContext context) {
    ...
    return chatapp.getNTPWrappedWidget(Scaffold(
    ...
    return GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              ...
              border: Border.all(
                color: widget.buttoncolor ?? chatappPRIMARYcolor,
              ),
              borderRadius:
              ...
              decoration: InputDecoration(
                  ...
                  hintStyle: widget.hintStyle ??
                      TextStyle(
                          ...
                          fontSize: 15.5,
                          fontWeight: FontWeight.w400,
                          color: widget.buttonhintTextColor ?? chatappGrey),
                ...
                decoration: InputDecoration(
                    ...
                    focusedBorder: OutlineInputBorder(
                      ...
                      borderRadius:
                          BorderRadius.circular(widget.boxcornerradius ?? 1),
                      borderSide:
                          BorderSide(color: chatappSECONDARYolor, width: 1.5),
                    ),
