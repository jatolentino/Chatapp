...
class _AuthenticateState extends State<Authenticate> {
      ...
      child = Material(
          ...
          child: Center(
            ...
            child: Text(
              ...
              style:
                  TextStyle(color: chatappWhite, fontSize: 18, height: 1.5),
            ),
          )));
    else {
      child = Container();
    }
    return chatapp.getNTPWrappedWidget(child);
  }
  ...
  _onPasscodeEntered(String enteredPasscode) {
    if (enteredPasscode.length == 4) {
      bool isValid =
          chatapp.getHashedAnswer(enteredPasscode) == widget.passcode;
      ...
      if (isValid) {
        ...
        if (passcodeTries > 3) {
          ...
          chatapp.toast(getTranslated(this.context, 'authfailed'));
          widget.state.pop();
        }
      }
    }
