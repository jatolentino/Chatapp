...
import 'package:chatapp/Screens/status/StatusView.dart';
import 'package:chatapp/Screens/status/components/ImagePicker/image_picker.dart';
import 'package:chatapp/Screens/status/components/TextStatus/textStatus.dart';
import 'package:chatapp/Screens/status/components/VideoPicker/VideoPicker.dart';
import 'package:chatapp/Screens/status/components/circleBorder.dart';
import 'package:chatapp/Screens/status/components/formatStatusTime.dart';
import 'package:chatapp/Screens/status/components/showViewers.dart';
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              color: statusProvider.contactsStatus[idx].data().containsKey(widget.currentUserNo)
                                                                                  ? statusProvider.contactsStatus[idx][Dbkeys.statusITEMSLIST].length > 0
                                                                                      ? chatappGreenColor500.withOpacity(0.8)
