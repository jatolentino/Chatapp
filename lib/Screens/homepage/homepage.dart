...
import 'package:chatapp/Screens/Broadcast/AddContactsToBroadcast.dart';
import 'package:chatapp/Screens/Groups/AddContactsToGroup.dart';
import 'package:chatapp/Screens/SettingsOption/settingsOption.dart';
import 'package:chatapp/Screens/homepage/Setupdata.dart';
import 'package:chatapp/Screens/notifications/AllNotifications.dart';
import 'package:chatapp/Screens/recent_chats/RecentChatsWithoutLastMessage.dart';
import 'package:chatapp/Screens/search_chats/SearchRecentChat.dart';
import 'package:chatapp/Screens/sharing_intent/SelectContactToShare.dart';
import 'package:chatapp/Screens/splash_screen/splash_screen.dart';
import 'package:chatapp/Screens/status/status.dart';
...
import 'package:chatapp/Services/Providers/StatusProvider.dart';
import 'package:chatapp/Services/Providers/call_history_provider.dart';
...
import 'package:chatapp/Utils/error_codes.dart';
import 'package:chatapp/Utils/phonenumberVariantsGenerator.dart';
...
import 'package:chatapp/Screens/profile_settings/profileSettings.dart';
...
import 'package:chatapp/Services/Providers/user_provider.dart';
...
class HomepageState extends State<Homepage>
  ...
  //       chatappWrapper.setLocale(context, _locale);
  //       setState(() {});
  //     }
  //   }).catchError((onError) {
  //     chatapp.toast(
  ...
  triggerSharing() {
    ...
    if (_sharedText != null) {
      ...
      if (_sharedFiles!.length > observer.maxNoOfFilesInMultiSharing) {
        chatapp.toast(getTranslated(context, 'maxnooffiles') +
            ' ' +
  ...
  logout(BuildContext context) async {
    ...
    Navigator.of(context).pushAndRemoveUntil(
      MaterialPageRoute(
        builder: (BuildContext context) => chatappWrapper(),
      ),
      (Route route) => false,
    );
  }
  ...
  void listenToNotification() async {
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) async {
      ...
      if (message.data['title'] != 'Call Ended' &&
        ...
        chatapp.toast(getTranslated(this.context, 'newnotifications'));
      } else {
  ...
  Future<bool> onWillPop() {
    ...
    if (now.difference(currentBackPressTime!) > Duration(seconds: 3)) {
      ...
      chatapp.toast(getTranslated(this.context, 'doubletaptogoback'));
                                                                  ...
                                                                  child: Row(
                                                                    ...
                                                                    children: <
                                                                      ...
                                                                      Language.languageList().length <
                                                                          ...
                                                                          : Icon(
                                                                              Icons.done,
                                                                              color: e.languageCode == widget.prefs.getString(LAGUAGE_CODE) ? chatappSECONDARYolor : Colors.transparent,
                                                                            )
                                                                    ],
                                                                  ),
                                                                ),
                                                                  ...
                                                                  Navigator.push(
                                                                      ...
                                                                      new MaterialPageRoute(
                                                                          builder: (context) => ProfileSetting(
                                                                                ...
                                                                                type: chatapp.getAuthenticationType(biometricEnabled, _cachedModel),
                                                                              )));
                                                                },
                                                                currentUserNo:
                                                                    widget
...
Widget errorScreen(String? title, String? subtitle) {
  return Scaffold(
    backgroundColor: chatappPRIMARYcolor,
    body: Center(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                  fontSize: 17,
                  color: chatappWhite.withOpacity(0.7),
