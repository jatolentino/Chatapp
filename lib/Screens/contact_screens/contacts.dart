...
class _ContactsState extends State<Contacts>
  ...
  Future<Map<String?, String?>> getContacts({bool refresh = false}) async {
    ...
    chatapp.checkAndRequestPermission(Permission.contacts).then((res) {
      if (res) {
        ...
        chatapp.showRationale(getTranslated(context, 'perm_contact'));
      ...
      chatapp.showRationale('Error occured: $onError');
    });
