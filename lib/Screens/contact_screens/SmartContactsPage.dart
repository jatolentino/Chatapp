...
import 'package:chatapp/Screens/contact_screens/contacts.dart';
...
import 'package:chatapp/Screens/chat_screen/pre_chat.dart';
import 'package:chatapp/Screens/contact_screens/AddunsavedContact.dart';
...
class _SmartContactsPageState extends State<SmartContactsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return PickupLayout(
        prefs: widget.prefs,
        scaffold: chatapp.getNTPWrappedWidget(ScopedModel<DataModel>(
            model: widget.model,
                      ...
                      actions: <Widget>[
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            ...
                            // chatapp.toast(getTranslated(context, "loading"));
                                                                        ...
                                                                        if (widget
                                                                          ...
                                                                          Text(
                                                                            ...
                                                                            textAlign:
                                                                                TextAlign.center,
                                                                            style:
                                                                                TextStyle(color: chatappGrey, fontSize: 11),
                                                                          ),
                                                                        SizedBox(
                                                                          height:
                                                                              30,
                                                                              ...
                                                                              if (sharedSecret != null && privateKey != null) {
                                                                                ...
                                                                                FirebaseFirestore.instance.collection(DbPaths.collectionusers).doc(widget.currentUserNo).collection(Dbkeys.lastSyncedContacts).doc(Dbkeys.lastSyncedContacts).set({
                                                                                  ...
                                                                                  FirebaseFirestore.instance.collection(DbPaths.collectionusers).doc(widget.currentUserNo).set({
                                                                                    ...
                                                                                    chatapp.toast(getTranslated(this.context, 'syncsuccess'));
                                                                                  }).catchError((e) {
                                                                                    chatapp.toast("${getTranslated(this.context, 'failedtosync')}\n\n $e");
                                                                                  });
                                                                                });
                                                                              } else {
                                                                                chatapp.toast("Failed ! Please try again .");
                                                                              }
                                                                            } catch (e) {
                                                                              chatapp.toast("${getTranslated(this.context, 'failedtosync')} \n\n- $e");
                                                                            }
                                                                              ...
                                                                              onPressed: () {
                                                                                ...
                                                                                FirebaseFirestore.instance.collection(DbPaths.collectionusers).doc(widget.currentUserNo).collection(Dbkeys.lastSyncedContacts).doc(Dbkeys.lastSyncedContacts).delete().then((value) {
                                                                                  FirebaseFirestore.instance.collection(DbPaths.collectionusers).doc(widget.currentUserNo).set({
                                                                                    ...
                                                                                    chatapp.toast(getTranslated(this.context, 'syncdeleted'));
                                                                                  }).catchError((e) {
                                                                                    chatapp.toast("Failed !\n\n $e");
                                                                                  });
                                                                                });
                                                                              },
                                                                              child: Text(
    ...
    return Stack(children: [
      Container(
        child: Center(
          ...
          valueColor: AlwaysStoppedAnimation<Color>(chatappSECONDARYolor),
        )),
      )
    ]);
  }
