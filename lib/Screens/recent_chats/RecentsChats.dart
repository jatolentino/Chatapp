...
import 'package:chatapp/Screens/recent_chats/widgets/getBroadcastMessageTile.dart';
import 'package:chatapp/Screens/recent_chats/widgets/getGroupMessageTile.dart';
import 'package:chatapp/Screens/recent_chats/widgets/getPersonalMessageTile.dart';
...
class RecentChatsState extends State<RecentChats> {
  ...
  buildPersonalMessage(
    ...
    String chatId =
        chatapp.getChatId(currentUserNo!, realTimePeerData[Dbkeys.phone]);
    return streamLoad(
