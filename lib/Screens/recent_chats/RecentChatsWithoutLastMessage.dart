...
import 'package:chatapp/Screens/Groups/GroupChatPage.dart';
import 'package:chatapp/Screens/contact_screens/SmartContactsPage.dart';
...
import 'package:chatapp/Screens/chat_screen/utils/messagedata.dart';
...
import 'package:chatapp/Utils/alias.dart';
...
class RecentChatsWithoutLastMessageState
                  ...
                  actions: [
                    ElevatedButton(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                            color: chatappPRIMARYcolor, fontSize: 18),
                      ),
                      onPressed: () {
                    ...
                    ElevatedButton(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                            color: chatappREDbuttonColor, fontSize: 18),
                      ),
                      onPressed: () async {
                        String chatId = chatapp.getChatId(
                        ...
                        if (currentUserNo != null &&
                          ...
                          chatapp.toast('Error Occured. Could not delete !');
                        }
                      },
                    )
                  ],
                ...
                actions: [
                  ElevatedButton(
                    ...
                    child: Text(
                      getTranslated(context, 'cancel'),
                      style:
                          TextStyle(color: chatappPRIMARYcolor, fontSize: 18),
                    ),
                    onPressed: () {
                      Navigator.of(context).pop();
                    },
                    ...
                    if (_cachedModel!.currentUser![Dbkeys.locked] != null &&
                      ...
                      if (widget.prefs.getString(Dbkeys.isPINsetDone) !=
                        ...
                        ChatController.authenticate(_cachedModel!,
                            ...
                            state: state,
                            shouldPop: false,
                            type: chatapp.getAuthenticationType(
  ...
  Stream<MessageData> getUnread(Map<String, dynamic> user) {
    String chatId = chatapp.getChatId(currentUserNo!, user[Dbkeys.phone]);
  ...
  Widget build(BuildContext context) {
    ...
    return chatapp.getNTPWrappedWidget(ScopedModel<DataModel>(
      model: getModel()!,
      child:
        ...
        return Scaffold(
          ...
          floatingActionButton: Padding(
            ...
            child: FloatingActionButton(
                ...
                backgroundColor: chatappSECONDARYolor,
                child: Icon(
                  Icons.chat,
                  size: 30.0,
                ),
