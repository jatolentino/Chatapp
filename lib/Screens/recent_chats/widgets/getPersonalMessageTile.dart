...
import 'package:chatapp/Screens/recent_chats/widgets/getMediaMessage.dart';
        ...
        builder: (BuildContext popable) => ListTile(
            ...
            onTap: () async {
              ...
              FirebaseFirestore.instance
                  ...
                  .doc(chatapp.getChatId(currentUserNo, peer[Dbkeys.phone]))
                  .update({
              ...
              peer[Dbkeys.lastSeen] == true ||
                  ...
                  ? Positioned(
                      ...
                      child: CircleAvatar(
                        ...
                        radius: 8,
                        child: CircleAvatar(
                          backgroundColor: chatappGreenColor400,
                          radius: 6,
                        ),
                      ))
                  : SizedBox()
            ...
            if (cachedModel.currentUser![Dbkeys.locked] != null &&
              ...
              if (prefs.getString(Dbkeys.isPINsetDone) != currentUserNo ||
                ...
                ChatController.authenticate(
                    ...
                    state: state,
                    shouldPop: false,
                    type: chatapp.getAuthenticationType(false, cachedModel),
