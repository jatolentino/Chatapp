...
import 'package:chatapp/widgets/Common/cached_image.dart';
  ...
  void _stopCallingSound(context) async {
    if (_mPlayer != null) {
      try {
        ...
        chatapp.toast("Failed to stop calling sound.  Error $e");
      }
    }
  }
    ...
    _engine.registerEventHandler(
      RtcEngineEventHandler(
        ...
        onUserJoined:
          ...
          // chatapp.toast('joined - ${connection.localUid}');
          Wakelock.enable();
          flutterLocalNotificationsPlugin.cancelAll();
        },
        ...
        onTokenPrivilegeWillExpire: (RtcConnection connection, String token) {
          ...
          chatapp.toast("Failed to Call. Please try calling again !");
          flutterLocalNotificationsPlugin.cancelAll();
        },
      ),
    );
