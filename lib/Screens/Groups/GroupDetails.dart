...
import 'package:chatapp/Screens/Groups/EditGroupDetails.dart';
...
class _GroupDetailsState extends State<GroupDetails> {
            ...
            actions: [
              ...
              ElevatedButton(
                ...
                child: Text(
                  ...
                  style:
                      TextStyle(color: chatappREDbuttonColor, fontSize: 18),
                ),
                onPressed: () async {
                  Navigator.of(context).pop();
                  setStateIfMounted(() {
  ...
  Widget build(BuildContext context) {
    ...
    return PickupLayout(
        prefs: widget.prefs,
        scaffold: chatapp.getNTPWrappedWidget(
