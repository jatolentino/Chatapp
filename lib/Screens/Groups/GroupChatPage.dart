...
import 'package:chatapp/Screens/Groups/GroupDetails.dart';
import 'package:chatapp/Screens/Groups/widget/groupChatBubble.dart';
...
import 'package:chatapp/Services/Providers/GroupChatProvider.dart';
...
import 'package:chatapp/widgets/InfiniteList/InfiniteCOLLECTIONListViewWidget.dart';
...
//       //----sharing intent action:
  ...
  //                       focusNode: keyboardFocusNode,
  //                       maxLines: null,
  //                       style: TextStyle(fontSize: 16.0, color: chatappBlack),
  //                       controller: textEditingController,
  //                       decoration: InputDecoration(
  //                         enabledBorder: OutlineInputBorder(
  //                           // width: 0.0 produces a thin "hairline" border
  ...
  //                       initCategory: emojipic.Category.RECENT,
  //                       bgColor: Color(0xFFF2F2F2),
  //                       indicatorColor: chatappgreen,
  //                       iconColor: Colors.grey,
  //                       iconColorSelected: chatappgreen,
  //                       progressIndicatorColor: Colors.blue,
  //                       backspaceColor: chatappgreen,
  //                       showRecentsTab: true,
  //                       recentsLimit: 28,
  ...
  //                             maxLines: null,
  //                             style: TextStyle(
  //                                 fontSize: 18.0, color: chatappBlack),
  //                             controller: textEditingController,
  //                             decoration: InputDecoration(
  //                               enabledBorder: OutlineInputBorder(
  //                                 // width: 0.0 produces a thin "hairline" border
              ...
              child: GroupChatBubble(
                ...
                child: doc[Dbkeys.groupmsgISDELETED] == true
                    ? Text(
                        ...
                        style: TextStyle(
                            color: chatappBlack.withOpacity(0.6),
                            fontSize: 15,
  ...
  Widget build(BuildContext context) {
    ...
    return PickupLayout(
        prefs: widget.prefs,
        scaffold: chatapp.getNTPWrappedWidget(Consumer<List<GroupModel>>(
