...
import 'dart:io';
import 'package:chatapp/Screens/homepage/Setupdata.dart';
import 'package:chatapp/Services/Providers/SmartContactProviderWithLocalStoreData.dart';
import 'package:chatapp/Services/localization/language.dart';
import 'package:chatapp/Utils/color_detector.dart';
import 'package:chatapp/Utils/custom_url_launcher.dart';
import 'package:chatapp/Utils/setStatusBarColor.dart';
import 'package:chatapp/Utils/theme_management.dart';
import 'package:chatapp/widgets/AllinOneCameraGalleryImageVideoPicker/AllinOneCameraGalleryImageVideoPicker.dart';
import 'package:chatapp/widgets/CameraGalleryImagePicker/camera_image_gallery_picker.dart';
import 'package:chatapp/widgets/CameraGalleryImagePicker/multiMediaPicker.dart';
import 'package:chatapp/widgets/DownloadManager/download_all_file_type.dart';
import 'package:chatapp/widgets/DynamicBottomSheet/dynamic_modal_bottomsheet.dart';
import 'package:chatapp/widgets/VideoEditor/video_editor.dart';
...
import 'package:chatapp/Screens/chat_screen/utils/aes_encryption.dart';
import 'package:chatapp/Screens/chat_screen/utils/uploadMediaWithProgress.dart';
import 'package:chatapp/Screens/contact_screens/SelectContactsToForward.dart';
import 'package:chatapp/Screens/security_screens/security.dart';
import 'package:chatapp/Services/Admob/admob.dart';
import 'package:chatapp/Utils/emoji_detect.dart';
import 'package:chatapp/Utils/mime_type.dart';
import 'package:chatapp/main.dart';
import 'package:chatapp/widgets/CountryPicker/CountryCode.dart';
import 'package:chatapp/Configs/Dbkeys.dart';
import 'package:chatapp/Configs/Dbpaths.dart';
import 'package:chatapp/Screens/chat_screen/utils/deleteChatMedia.dart';
import 'package:chatapp/Screens/privacypolicy&TnC/PdfViewFromCachedUrl.dart';
import 'package:chatapp/Services/Providers/Observer.dart';
import 'package:chatapp/widgets/MultiDocumentPicker/multiDocumentPicker.dart';
import 'package:chatapp/widgets/MyElevatedButton/MyElevatedButton.dart';
import 'package:chatapp/widgets/SoundPlayer/SoundPlayerPro.dart';
import 'package:chatapp/Services/Providers/currentchat_peer.dart';
...
import 'package:chatapp/Screens/chat_screen/utils/audioPlayback.dart';
import 'package:chatapp/Screens/chat_screen/utils/message.dart';
import 'package:chatapp/Screens/contact_screens/ContactsSelect.dart';
import 'package:chatapp/Models/DataModel.dart';
import 'package:chatapp/Screens/chat_screen/utils/photo_view.dart';
import 'package:chatapp/Screens/profile_settings/profile_view.dart';
import 'package:chatapp/Services/Providers/seen_provider.dart';
import 'package:chatapp/Services/Providers/seen_state.dart';
...
import 'package:chatapp/Utils/chat_controller.dart';
import 'package:chatapp/Utils/crc.dart';
import 'package:chatapp/Utils/open_settings.dart';
import 'package:chatapp/Utils/save.dart';
import 'package:chatapp/Utils/utils.dart';
import 'package:chatapp/widgets/AudioRecorder/Audiorecord.dart';
import 'package:chatapp/widgets/ImagePicker/image_picker.dart';
import 'package:chatapp/widgets/VideoPicker/VideoPreview.dart';
import 'package:chatapp/Screens/chat_screen/Widget/bubble.dart';
...
import 'package:chatapp/Models/E2EE/e2ee.dart' as e2ee;
...
class _ChatScreenState extends State<ChatScreen> with WidgetsBindingObserver {
  ...
  String decryptWithCRC(String input) {
    ...
    // chatapp.toast(getTranslated(this.context, 'msgnotload'));
    return '';
  }
  ...
  readLocal(
    ...
    chatId = chatapp.getChatId(currentUserNo!, peerNo!);
  ...
  Future uploadFile(bool isthumbnail, {int? timestamp}) async {
    ...
    if (isthumbnail == true) {
      ...
      await _mediaInfo.getMediaInfo(thumbnailFile.path).then((mediaInfo) {
        ...
        chatapp.toast(getTranslated(this.context, 'failedsending'));
  ...
  void _changeLanguage(Language language) async {
    ...
    chatappWrapper.setLocale(this.context, _locale);
    ...
    if (content.trim() != '') {
      ...
      try {
        ...
        if (encrypted is String) {
          ...
          chatapp.toast('Nothing to encrypt');
        }
      } on Exception catch (_) {
        // debugPrint('Exception caught!');
        chatapp.toast("Exception: $_");
      }
    }
  }
          ...
          builder: (BuildContext popable) => ListTile(
              ...
              onTap: () async {
                ...
                await FirebaseFirestore.instance
                    ...
                    .then((chatDoc) async {
                  if (!chatDoc.exists) {
                    chatapp.toast('Please reload this screen !');
              ...
              onTap: () async {
                ...
                if ((mssgDoc.containsKey(Dbkeys.isbroadcast) == true
                  ...
                  await deleteMsgMedia(mssgDoc, chatId!)
                      .then((isDeleted) async {
                    if (isDeleted == false || isDeleted == null) {
                      chatapp.toast('Could not delete. Please try again!');
                    } else {
                      await FirebaseFirestore.instance
                          .collection(DbPaths.collectionmessages)
                          .doc(chatId)
      ...
      tiles.add(Builder(
          builder: (BuildContext popable) => ListTile(
              ...
              onTap: () {
                ...
                chatapp.toast(getTranslated(popable, 'copied'));
                Navigator.of(popable).pop();
              })));
    }
    if (((mssgDoc[Dbkeys.from] == currentUserNo &&
      ...
      tiles.add(Builder(
          builder: (BuildContext popable) => ListTile(
              ...
              onTap: () async {
                Navigator.of(popable).pop();
                try {
                  var v = await chatapp.translateString(
    ...
    if (index >= list.length) {
      ...
      if (list[index].containsKey(Dbkeys.groupNAME)) {
        try {
          ...
          chatapp.toast('Failed to send $e');
        }
      } else {
        try {
          ...
          if (encrypted is String) {
            ...
            chatapp.toast('Nothing to send');
          }
        } catch (e) {
          setStateIfMounted(() {
            isgeneratingSomethingLoader = false;
          });
          chatapp.toast('Failed to Forward message. Error:$e');
        }
      }
    }
  }
                          ...
                          Container(
                              child: Row(
                                ...
                                Text(getTranslated(this.context, 'forwarded'),
                                    maxLines: 1,
                                    style: TextStyle(
                                        color: chatappGrey.withOpacity(0.7),
                                        fontStyle: FontStyle.italic,
          ...
          ElevatedButton(
              ...
              onPressed: () async {
                ...
                if (isUser == null || isUser == false) {
                  chatapp.toast(getTranslated(this.context, 'usernotjoined') +
                      ' $Appname');
                }
              },
  ...
  replyAttachedWidget(BuildContext context, var doc) {
    return Flexible(
      child: Container(
          ...
          decoration: BoxDecoration(
              color: chatappWhite.withOpacity(0.55),
          ...
          child: Stack(
            children: [
              Container(
                  ...
                  decoration: BoxDecoration(
                      color: chatappGrey.withOpacity(0.1),
      ...
      child: isgeneratingSomethingLoader
          ? Container(
              child: Center(
                child: CircularProgressIndicator(
                    valueColor:
                        AlwaysStoppedAnimation<Color>(chatappPRIMARYcolor)),
              ),
              color: pickTextColorBasedOnBgColorAdvanced(
                      !Thm.isDarktheme(widget.prefs)
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          maxLines: 2,
                          overflow: TextOverflow.ellipsis,
                          style: TextStyle(color: chatappGrey, fontSize: 14),
                        )
                      ],
                    ),
                  ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          maxLines: 2,
                          overflow: TextOverflow.ellipsis,
                          style: TextStyle(color: chatappGrey),
                        )
                      ],
                    ),
                  ),
        ...
        actions: <Widget>[
          ...
          ElevatedButton(
              ...
              child: Text(getTranslated(this.context, 'acpt'),
                  style: TextStyle(color: chatappPRIMARYcolor)),
              onPressed: () {
                      ...
                      children: [
                        ...
                        Flexible(
                          child: TextField(
                            ...
                            style: TextStyle(
                                fontSize: 16.0, color: chatappBlack),
                      ...
                      icon: textInSendButton == ""
                          ? new Icon(
                              textEditingController.text.length == 0
                                  ? Icons.mic
                                  : Icons.send,
                              color: chatappWhite.withOpacity(0.99),
                            )
                          : textEditingController.text.length == 0
                              ? new Icon(
                                  Icons.mic,
                  ...
                  child: SizedBox(
                    ...
                    child: EmojiPicker(
                        ...
                        config: Config(
                            ...
                            indicatorColor: chatappPRIMARYcolor,
                            iconColor: Colors.grey,
                            iconColorSelected: chatappPRIMARYcolor,
                            progressIndicatorColor: Colors.blue,
                            backspaceColor: chatappPRIMARYcolor,
                            showRecentsTab: true,
                            recentsLimit: 28,
        ...
        for (final doc in docs.docs) {
          ...
          try {
            ...
            if (e.toString().contains('range')) {
              chatapp.toast(getTranslated(this.context, 'failedtoloadchat'));
              Navigator.of(this.context).pop();
            }
          }
        }
...
//-- GROUP BY DATE ---
  ...
  Widget build(BuildContext context) {
    ...
    return PickupLayout(
      prefs: widget.prefs,
      scaffold: chatapp.getNTPWrappedWidget(WillPopScope(
              ...
              child: ScopedModelDescendant<DataModel>(
                ...
                return peer != null
                    ? peer![Dbkeys.accountstatus] == Dbkeys.sTATUSdeleted
                        ? Scaffold(
                            backgroundColor: Thm.isDarktheme(widget.prefs)
                                ? chatappCHATBACKGROUNDDarkMode
                                : chatappCHATBACKGROUNDLightMode,
                            appBar: AppBar(
                              backgroundColor: Thm.isDarktheme(widget.prefs)
                                  ? chatappAPPBARcolorDarkMode
                                  : chatappAPPBARcolorLightMode,
                                            ...
                                            onSelected: (dynamic val) {
                                              switch (val) {
                                                                    ...
                                                                    myElevatedButton(
                                                                        ...
                                                                        onPressed:
                                                                          ...
                                                                          Map<String, dynamic>
                                                                            ...
                                                                            'id':
                                                                                chatapp.getChatId(currentUserNo!, peerNo!),
                                                                          };
                                                                          ...
                                                                          await FirebaseFirestore
                                                                              ...
                                                                              .then((value) async {
                                                                            showModalBottomSheet(
                                                                                backgroundColor: Thm.isDarktheme(widget.prefs) ? chatappDIALOGColorDarkMode : chatappDIALOGColorLightMode,
                                                                                isScrollControlled: true,
                                                                                context: context,
                                                                                shape: RoundedRectangleBorder(
                                                                                  borderRadius: BorderRadius.vertical(top: Radius.circular(25.0)),
                                                                                  ...
                                                                                  return Container(
                                                                                    ...
                                                                                    child: Padding(
                                                                                      ...
                                                                                      child: Column(
                                                                                        mainAxisAlignment: MainAxisAlignment.center,
                                                                                        children: [
                                                                                          Icon(Icons.check, color: chatappGreenColor400, size: 40),
                                                                                          SizedBox(
                                                                                            height: 30,
                                                                                          ),
                                                                                          Text(
                                                                                            ...
                                                                                            textAlign: TextAlign.center,
                                                                                            style: TextStyle(
                                                                                              color: pickTextColorBasedOnBgColorAdvanced(Thm.isDarktheme(widget.prefs) ? chatappDIALOGColorDarkMode : chatappDIALOGColorLightMode),
                                                                                            ),
                                                                                          )
                                                                                        ],
                                                                                      ),
                                                ...
                                                case 'remove_wallpaper':
                                                  ...
                                                  // chatapp.toast('Wallpaper removed.');
                                                  break;
                                                case 'set_wallpaper':
                                                  Navigator.push(
                                                      context,
  ...
  deleteAllChats() async {
    if (messages.length > 0) {
      chatapp.toast(getTranslated(this.context, 'deleting'));
      await FirebaseFirestore.instance
          .collection(DbPaths.collectionmessages)
          .doc(chatId)
          .get()
