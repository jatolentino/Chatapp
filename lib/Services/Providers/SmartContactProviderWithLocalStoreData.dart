            ...
            return [
              Padding(
                ...
                child: Text(
                  ...
                  style: TextStyle(height: 1.3, color: chatappGrey),
                ),
              ),
              Padding(
  ...
  searchAvailableContactsInDb(
    ...
    if (existingPrefs.getString('lastTimeCheckedContactBookSavedCopy') ==
      ...
      List<String> myArray = contactsBookContactList!.entries
          ...
          .toList();
      List<List<String>> chunkList = chatapp.divideIntoChuncks(myArray, 10);

      List<List<List<String>>> chunkgroups = chatapp.divideIntoChuncksGroup(
