...
import 'package:chatapp/Services/Providers/FirebaseAPIProvider.dart';
        ...
        await FirebaseFirestore.instance
          ...
          try {
            ...
            if (encrypted is String) {
              ...
              if (content.trim() != '') {
                var chatId = chatapp.getChatId(currentUserNo, peer);
                await FirebaseFirestore.instance
                    .collection(DbPaths.collectionbroadcasts)
                    .doc(broadcastId)
                    .collection(DbPaths.collectionbroadcastsChats)
            ...
            chatapp.toast('Failed to Send message. Error:$e');
          }
        }).catchError(((e) {
          chatapp.toast('Failed to Send message. Error:$e');
        }));
