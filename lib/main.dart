...
import 'package:chatapp/Screens/homepage/initialize.dart';
...
import 'package:chatapp/Services/Providers/LazyLoadingChatProvider.dart';
...
import 'package:chatapp/Services/localization/demo_localization.dart';
import 'package:chatapp/Services/localization/language_constants.dart';
import 'package:chatapp/Services/Providers/DownloadInfoProvider.dart';
...
void main() async {
  ...
  SystemChrome.setPreferredOrientations([DeviceOrientation.portraitUp])
      .then((_) {
    runApp(OverlaySupport(child: chatappWrapper()));
  });
}

class chatappWrapper extends StatefulWidget {
  const chatappWrapper({Key? key}) : super(key: key);
  static void setLocale(BuildContext context, Locale newLocale) {
    _chatappWrapperState state =
        context.findAncestorStateOfType<_chatappWrapperState>()!;
    state.setLocale(newLocale);
  }

  @override
  _chatappWrapperState createState() => _chatappWrapperState();
}

class _chatappWrapperState extends State<chatappWrapper> {
                      ...
                      child: MaterialApp(
                          theme: ThemeData(
                              fontFamily: FONTFAMILY_NAME == ''
                                  ? null
                                  : FONTFAMILY_NAME,
                              primaryColor: chatappPRIMARYcolor,
                              primaryColorLight: chatappPRIMARYcolor,
